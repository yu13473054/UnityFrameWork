...
{
    public class AssetDepPrefabWindow : AssetBaseWindow
    {
        private bool m_FilterEmpty;

        //查找选中资源依赖的对象
        [MenuItem("Assets/查找被哪些Prefab依赖", false, 202)]
        static void FindDependence()
        {
            List<string> queryFileList = AssetDanshariUtility.GetSelectAssets();
            CheckPaths<AssetDepPrefabWindow>(queryFileList);
        }
        ...
        private void Awake()
        {
            ...
            _treeModel = new AssetDepPrefabModel();
