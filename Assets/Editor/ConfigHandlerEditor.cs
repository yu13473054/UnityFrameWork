...
/// 配置txt文件读取工具
public class ConfigHandlerEditor
{
	/// <summary>
	/// 节点值
	/// </summary>
    ...
    /// 构造
    /// </summary>
    public ConfigHandlerEditor()
    {
		_dict = new Dictionary<string, string>();
    }

    public ConfigHandlerEditor(string filePath) : this()
    {
        _filePath = filePath;
    }
    ...
    /// 打开TXT文件
    /// </summary>
    public static ConfigHandlerEditor Open( string filePath )
    {
        ConfigHandlerEditor handler = new ConfigHandlerEditor(filePath);
        //直接按照路径获取
	...
	public void WriteValue(string key, object value)
	{
        if(string.IsNullOrEmpty(_filePath))
            UnityEngine.Debug.LogError("<ConfigHandlerEditor> 写入的文件的路径为空！");
