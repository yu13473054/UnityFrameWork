...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(LuaFramework.TimerEleCallBack), factory.LuaFramework_TimerEleCallBack);
		...
		DelegateTraits<LuaFramework.TimerEleCallBack>.Init(factory.LuaFramework_TimerEleCallBack);
		...
		TypeTraits<LuaFramework.TimerEleCallBack>.Init(factory.Check_LuaFramework_TimerEleCallBack);
		...
		StackTraits<LuaFramework.TimerEleCallBack>.Push = factory.Push_LuaFramework_TimerEleCallBack;
	...
	class LuaFramework_TimerEleCallBack_Event : LuaDelegate
	{
		public LuaFramework_TimerEleCallBack_Event(LuaFunction func) : base(func) { }
		public LuaFramework_TimerEleCallBack_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(LuaFramework.TimerElement param0)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(LuaFramework.TimerElement param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public LuaFramework.TimerEleCallBack LuaFramework_TimerEleCallBack(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			LuaFramework.TimerEleCallBack fn = delegate(LuaFramework.TimerElement param0) { };
			return fn;
		}

		if(!flag)
		{
			LuaFramework_TimerEleCallBack_Event target = new LuaFramework_TimerEleCallBack_Event(func);
			LuaFramework.TimerEleCallBack d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			LuaFramework_TimerEleCallBack_Event target = new LuaFramework_TimerEleCallBack_Event(func, self);
			LuaFramework.TimerEleCallBack d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_LuaFramework_TimerEleCallBack(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(LuaFramework.TimerEleCallBack), L, pos);
	}

	void Push_LuaFramework_TimerEleCallBack(IntPtr L, LuaFramework.TimerEleCallBack o)
	{
		ToLua.Push(L, o);
	}
