...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaFramework_MyUtilsWrap.Register(L);
		...
		LuaFramework_GameMainWrap.Register(L);
		LuaFramework_LuaMgrWrap.Register(L);
		LuaFramework_UIMgrWrap.Register(L);
		LuaFramework_SoundMgrWrap.Register(L);
		LuaFramework_TimerMgrWrap.Register(L);
		LuaFramework_ThreadManagerWrap.Register(L);
		LuaFramework_NetworkMgrWrap.Register(L);
		LuaFramework_ResMgrWrap.Register(L);
		L.RegFunction("TimerEleCallBack", LuaFramework_TimerEleCallBack);
		L.EndModule();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int LuaFramework_TimerEleCallBack(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<LuaFramework.TimerEleCallBack>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<LuaFramework.TimerEleCallBack>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
