...
public class LuaFramework_NetworkMgrWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(LuaFramework.NetworkMgr), typeof(UnityEngine.MonoBehaviour));
	...
	static int OnInit(IntPtr L)
	{
		try
		{
			...
			LuaFramework.NetworkMgr obj = (LuaFramework.NetworkMgr)ToLua.CheckObject<LuaFramework.NetworkMgr>(L, 1);
			obj.OnInit();
			return 0;
		}
		catch (Exception e)
	...
	static int AddEvent(IntPtr L)
	{
		try
		{
			...
			LuaFramework.NetworkMgr.AddEvent(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int SendMessage(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.NetworkMgr.SendMessage");
			}
		}
		catch (Exception e)
		{
	...
	static int get_Inst(IntPtr L)
	{
		try
		{
			ToLua.Push(L, LuaFramework.NetworkMgr.Inst);
			return 1;
		}
		catch (Exception e)
		{
