...
public class LuaFramework_LuaHelperWrap
{
	...
	static int GetPanelManager(IntPtr L)
	{
		try
		{
			...
			LuaFramework.UIMgr o = LuaFramework.LuaHelper.GetPanelManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int GetResManager(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			LuaFramework.ResMgr o = LuaFramework.LuaHelper.GetResManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int GetNetManager(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			LuaFramework.NetworkMgr o = LuaFramework.LuaHelper.GetNetManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int GetSoundManager(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			LuaFramework.SoundMgr o = LuaFramework.LuaHelper.GetSoundManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
