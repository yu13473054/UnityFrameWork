...
public class LuaFramework_AppConstWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("DataDir", get_DataDir, null);
		L.RegVar("DataABName", get_DataABName, null);
		L.RegVar("PrefabDir", get_PrefabDir, null);
		L.RegVar("PrefabABName", get_PrefabABName, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_DataDir(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.DataDir);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_DataABName(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.DataABName);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_PrefabDir(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.PrefabDir);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_PrefabABName(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.PrefabABName);
			return 1;
		}
		catch (Exception e)
		{
